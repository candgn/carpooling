...
public class Bestaetigung extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_bestaetigung, menu);
        return true;
    }
...
*/
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_bestaetigung, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
           ...
           switch (position){
               case 0:
                   fragment = new FragAktuell();
                   break;
               case 1:
                   fragment = new FragVergangen();
                   break;
               default:
