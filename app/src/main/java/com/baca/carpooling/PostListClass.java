...
public class PostListClass extends ArrayAdapter<String> {



    private final ArrayList<String> name,erklaerung,datum,ausgang,ziel,uid,auto,postid,image;
    private Activity context;
    Anzeige anzeigeClass;
    ImageView anwenden;
    String can;

        public PostListClass(Anzeige anzeigeClass, ArrayList<String> erklaerung, ArrayList<String> datum,ArrayList<String> name, ArrayList<String> ausgang, ArrayList<String> ziel,ArrayList<String> image, ArrayList<String> uid,ArrayList<String>postid, ArrayList<String> auto,  Activity context){
    ...
    private View.OnClickListener iwlistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            ListView lw = (ListView) pr.getParent();
            final int position = lw.getPositionForView(pr);
            Intent intent = new Intent(anzeigeClass.getApplicationContext(),DetalierteProfil.class);
            intent.putExtra("uid",uid.get(position));
            context.startActivity(intent);
            System.out.println("---------------- " + position);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        anwenden = (ImageView) postview.findViewById(R.id.buttonanwenden);
