...
public class AnwendenPostlistClassVergangen  extends ArrayAdapter<String> {
    private final ArrayList<String> postid,uid,trefflat,trefflon,statu;
    private Activity context;
    FragVergangen fragVergangen;
    Button anwenden;
    String can,ausgang,ziel,carControl;

    public AnwendenPostlistClassVergangen(FragVergangen fragVergangen,  ArrayList<String> postid, ArrayList<String> uid,ArrayList<String>trefflat,ArrayList<String>trefflon,ArrayList<String>statu,  Activity context){
        super( context,R.layout.anwenden_view,postid);
        ...
        this.statu = statu;
        this.fragVergangen = fragVergangen;
    ...
    private View.OnClickListener mylistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent (fragVergangen.getActivity(), VergangeneAnzeigeDetail.class);


            intent.putExtra("postid",postid.get(position));
            intent.putExtra("uid",uid.get(position));
            intent.putExtra("trefflat",trefflat.get(position));
            intent.putExtra("trefflon",trefflon.get(position));
            intent.putExtra("statu",statu.get(position));
    ...
    private View.OnClickListener iwlistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            ListView lw = (ListView) pr.getParent();
            final int position = lw.getPositionForView(pr);
            Intent intent = new Intent(fragVergangen.getActivity(),DetalierteProfil.class);
            intent.putExtra("uid",uid.get(position));
            context.startActivity(intent);
